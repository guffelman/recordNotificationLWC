Webruntime.define('lwc/recordNotificationLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    class RecordNotificationLWC extends lwc.LightningElement {
      ...
      renderedCallback() {
        if (this.template.querySelector('[data-id="warning-card"].warning')) {
          this.template.querySelector('[data-id="warning-card"].warning').className = this.type;
        } else if (this.template.querySelector('[data-id="warning-card"].error')) {
          this.template.querySelector('[data-id="warning-card"].error').className = this.type;
        } else if (this.template.querySelector('[data-id="warning-card"].success')) {
          this.template.querySelector('[data-id="warning-card"].success').className = this.type;
        } else if (this.template.querySelector('[data-id="warning-card"].info')) {
          this.template.querySelector('[data-id="warning-card"].info').className = this.type;
        } else {
          this.template.querySelector('[data-id="warning-card"].warning').className = this.type;
        }
      }
