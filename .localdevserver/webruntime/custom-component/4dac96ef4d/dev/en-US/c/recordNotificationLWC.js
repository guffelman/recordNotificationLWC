Webruntime.define('lwc/recordNotificationLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    class RecordNotificationLWC extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.symbol = '!';
        this.type = 'warning';
        this.bgColor = 'background-color: rgba(255, 255, 0, 0.2);';
      ...
      connectedCallback() {
        switch (this.type) {
          case 'warning':
            this.symbol = '!';
            this.symbolContainer = 'background-color: rgba(255, 255, 124, 0.7); box-shadow: 0 0 0 5px rgba(255, 255, 124, 0.7);';
            this.color = 'background-color: rgba(255, 255, 0, 0.6);';
            break;
          case 'error':
            this.symbol = 'X';
            this.symbolContainer = 'background-color: rgba(255, 0, 0, 0.7); box-shadow: 0 0 0 5px rgba(255, 0, 0, 0.7);';
            this.color = 'background-color: rgba(255, 0, 0, 0.6);';
            break;
          case 'success':
            this.symbol = '✓';
            this.symbolContainer = 'background-color: rgba(0, 255, 0, 0.7); box-shadow: 0 0 0 5px rgba(0, 255, 0, 0.7); ';
            this.color = 'background-color: rgba(0, 255, 0, 0.6);';
            break;
          case 'info':
            this.symbol = 'i';
            this.symbolContainer = 'background-color: rgba(0, 0, 255, 0.7); box-shadow: 0 0 0 5px rgba(0, 0, 255, 0.7);';
            this.color = 'background-color: rgba(0, 0, 255, 0.6);';
            break;
          default:
            this.symbol = '!';
            this.symbolContainer = 'background-color: rgba(255, 255, 124, 0.7); box-shadow: 0 0 0 5px rgba(255, 255, 124, 0.7);';
