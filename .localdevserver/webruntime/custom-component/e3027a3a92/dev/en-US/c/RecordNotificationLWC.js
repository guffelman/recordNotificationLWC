Webruntime.define('lwc/RecordNotificationLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "body" + shadowSelector + " {font-family: Arial, sans-serif;background-color: #f0f0f0;display: flex;justify-content: center;align-items: center;height: 100vh;margin: 0;}\n.warning-card" + shadowSelector + " {background-color: rgba(255, 255, 0, 0.7);border-radius: 10px;padding: 20px;width: 300px;box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);text-align: center;}\n.exclamation" + shadowSelector + " {font-size: 36px;color: red;margin-bottom: 10px;}\n";
    }
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 1
      }, [api_text("This is a warning message. Please be cautious.")])])];
    }
