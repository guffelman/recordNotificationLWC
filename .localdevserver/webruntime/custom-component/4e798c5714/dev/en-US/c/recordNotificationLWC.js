Webruntime.define('lwc/recordNotificationLWC', ['lwc'], function (lwc) { 'use strict';
    ...
    class RecordNotificationLWC extends lwc.LightningElement {
      ...
      renderedCallback() {
        ...
        switch (this.type) {
          case 'warning':
            querySelector = '[data-id="warning-card"].warning';
            break;
          case 'error':
            querySelector = '[data-id="warning-card"].error';
            break;
          case 'success':
            querySelector = '[data-id="warning-card"].success';
            break;
          case 'info':
            querySelector = '[data-id="warning-card"].info';
            break;
          default:
            querySelector = '[data-id="warning-card"].warning';
        }
        if (this.template.querySelector(querySelector)) {
          this.template.querySelector(querySelector).className = this.type;
        }
      }
    }
